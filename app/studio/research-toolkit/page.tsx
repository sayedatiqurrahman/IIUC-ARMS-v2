...
const ResearchToolkit = dynamic(() => import('@/components/studio/ResearchToolkit'), { ssr: false });
      ...
      <div className="rounded-2xl border border-dark-border bg-dark-bg2/60 overflow-hidden">
        <div className="flex items-center gap-3 px-5 py-4 border-b border-dark-border bg-dark-bg2">
          <div className="w-10 h-10 rounded-xl bg-qsis/15 flex items-center justify-center flex-shrink-0">
            <span className="material-symbols-outlined text-qsis text-xl">school</span>
          </div>
          <div>
            <h2 className="text-[0.9rem] font-bold text-dark-text">Research Toolkit</h2>
            <p className="text-[0.68rem] text-dark-text2">Citations, transliteration, glossary, summarizer, analyzers, AI-style checks and more — English + Arabic, in your browser.</p>
          </div>
        </div>
        <div className="p-5">
          <ResearchToolkit />
