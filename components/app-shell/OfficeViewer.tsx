...
// doc/docx/xlsx/pptx preview via the Microsoft Office online viewer. Viewing is
// inline only — nothing is downloaded unless the user clicks Download/Open.
  ...
  return (
    <div ref={rootRef} className="image-viewer-container">
      <div className="image-toolbar">
        ...
        <a className="pdf-btn no-underline" href={item.rawUrl} download={item.name} title="Download" style={{ textDecoration: 'none' }}><i className="fas fa-download"></i></a>
      ...
      <div className="flex-1 overflow-hidden relative bg-[#0a0f1e]">
        {failed ? (
          <div className="flex flex-col items-center justify-center h-full text-dark-text2 px-6 text-center">
            ...
            <p className="text-[0.78rem] text-dark-text3 mb-4">Open it with the link below.</p>
