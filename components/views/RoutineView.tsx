...
import RoutineActionsMenu from '@/components/routine/RoutineActionsMenu';
        ...
        <>
          <div className="routine-page-header no-print">
            ...
            <div className="routine-page-actions">
              <RoutineActionsMenu
                onNewRoutine={() => { setImportPayload(null); setEditingId(null); setViewMode('builder'); }}
                onAllSemesterRoutine={canPublish ? () => setViewMode('allBranch') : undefined}
                onImport={openBuilderWithImport}
              />
