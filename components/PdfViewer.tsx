...
export default function PdfViewer({ url, name, filePath, onClose }: PdfViewerProps) {
  ...
  async function renderPage(pdfDoc: any, pageNum: number, s: number) {
      ...
      <div className="pdf-viewer-container" onClick={e => e.stopPropagation()}>
        ...
        <div className="pdf-topbar">
          ...
          <div className="pdf-topbar-right">
            ...
            <button onClick={zoomFit} className="pdf-zoom-btn" title="Fit"><i className="fas fa-expand"></i></button>
        ...
        {showToolbar && (
          <div className="pdf-annotation-bar">
            <button className={`pdf-ann-btn ${tool === 'none' ? 'active' : ''}`} onClick={() => setTool('none')} title="Select">
              <i className="fas fa-mouse-pointer"></i>
            </button>
            <button className={`pdf-ann-btn ${tool === 'highlight' ? 'active' : ''}`} onClick={() => setTool('highlight')} title="Highlight">
              <i className="fas fa-highlighter"></i>
            </button>
            <button className={`pdf-ann-btn ${tool === 'draw' ? 'active' : ''}`} onClick={() => setTool('draw')} title="Draw">
              <i className="fas fa-pen"></i>
            </button>
            <button className={`pdf-ann-btn ${tool === 'text' ? 'active' : ''}`} onClick={() => setTool('text')} title="Add Text">
              <i className="fas fa-font"></i>
            </button>
            <button className={`pdf-ann-btn ${tool === 'rect' ? 'active' : ''}`} onClick={() => setTool('rect')} title="Rectangle">
              <i className="far fa-square"></i>
            </button>
            <button className={`pdf-ann-btn ${tool === 'circle' ? 'active' : ''}`} onClick={() => setTool('circle')} title="Circle">
            ...
            <select value={drawWidth} onChange={e => setDrawWidth(parseInt(e.target.value))} className="pdf-width-select" title="Width">
